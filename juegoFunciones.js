...
var identificadorJ1 = "";
var identificadorJ2 = "";
var contenidoOriginal = document.getElementById("juego").innerHTML;
...
function perderJuego() {
  intentosClick++;
  if (intentosClick == 3) {
    document.getElementById("juego").innerHTML = "Perdiste!";
  }
}
function volverAIntentar() {
  {
    document.getElementById("juego").innerHTML = contenidoOriginal;
    document.getElementById("juego").style.opacity=0.3;
  }
};